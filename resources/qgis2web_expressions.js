...
function exp__5rule0_eval_expression(context) {
    // population >= 3022 AND population <= 5000

    var feature = context.feature;
    
    if (feature.properties) {
        return ((feature.get('population')  >= 3022.0) && (feature.get('population')  <= 5000.0));
    } else {
        return ((feature.get('population')  >= 3022.0) && (feature.get('population')  <= 5000.0));
    }
}
...
function exp__5rule1_eval_expression(context) {
    // population > 5000 AND population <= 10000

    var feature = context.feature;
    
    if (feature.properties) {
        return ((feature.get('population')  > 5000.0) && (feature.get('population')  <= 10000.0));
    } else {
        return ((feature.get('population')  > 5000.0) && (feature.get('population')  <= 10000.0));
    }
}
...
function exp__5rule2_eval_expression(context) {
    ...
    if (feature.properties) {
        return ((feature.get('population')  > 10000.0) && (feature.get('population')  <= 50000.0));
    } else {
        return ((feature.get('population')  > 10000.0) && (feature.get('population')  <= 50000.0));
    }
}
...
function exp__5rule3_eval_expression(context) {
    // population > 50000 AND population <= 100000

    var feature = context.feature;
    
    if (feature.properties) {
        return ((feature.get('population')  > 50000.0) && (feature.get('population')  <= 100000.0));
    } else {
        return ((feature.get('population')  > 50000.0) && (feature.get('population')  <= 100000.0));
    }
}
...
function exp__5rule4_eval_expression(context) {
    // population > 100000 AND population <= 500000

    var feature = context.feature;
    
    if (feature.properties) {
        return ((feature.get('population')  > 100000.0) && (feature.get('population')  <= 500000.0));
    } else {
        return ((feature.get('population')  > 100000.0) && (feature.get('population')  <= 500000.0));
    }
}
...
function exp__5rule5_eval_expression(context) {
    // population > 500000 AND population <= 1e+06

    var feature = context.feature;
    
    if (feature.properties) {
        return ((feature.get('population')  > 500000.0) && (feature.get('population')  <= 1000000.0));
    } else {
        return ((feature.get('population')  > 500000.0) && (feature.get('population')  <= 1000000.0));
    }
}
...
function exp__5rule6_eval_expression(context) {
    // population > 1e+06 AND population <= 1.63385e+06

    var feature = context.feature;
    
    if (feature.properties) {
        return ((feature.get('population')  > 1000000.0) && (feature.get('population')  <= 1633851.0));
    } else {
        return ((feature.get('population')  > 1000000.0) && (feature.get('population')  <= 1633851.0));
    }
}